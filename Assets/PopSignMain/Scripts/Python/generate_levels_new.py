...
def create_file_from_words(level_words, level_number):
    ...
    with open(new_video_path, 'w+') as f:
        ...
        f.write('\t"bluefolderName":"MacarthurBates/' +
        ...
        f.write('\t"greenfolderName":"MacarthurBates/' +
        ...
        f.write('\t"redfolderName":"MacarthurBates/' +
        ...
        f.write('\t"violetfolderName":"MacarthurBates/' +
        ...
        f.write('\t"yellowfolderName":"MacarthurBates/' +
