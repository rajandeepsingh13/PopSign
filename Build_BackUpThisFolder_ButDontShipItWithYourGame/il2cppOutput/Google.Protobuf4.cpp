...
IL2CPP_EXTERN_C const RuntimeMethod* SingleFieldAccessor_GetDefaultValue_m124C3C618D7EC5C04D23DFBADF4BD11D70235BD0_RuntimeMethod_var;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR RuntimeObject* SingleFieldAccessor_GetDefaultValue_m124C3C618D7EC5C04D23DFBADF4BD11D70235BD0 (FieldDescriptor_t4E024D7AB0DB4A8B264DAB8AC4F510135CF4547E* ___descriptor0, const RuntimeMethod* method) ;
...
IL_00f7:
	{
		...
		String_t* L_47;
		L_47 = String_Concat_mAF2CE02CC0CB7460753D0A1A91CCF2B1E9804C5D(_stringLiteral795419E0019C339EB191F029F9E7E9EBD13BCFAD, L_46, NULL);
		PropertyInfo_t* L_48;
		L_48 = RuntimeReflectionExtensions_GetRuntimeProperty_m8B8DEA120CC82BEDC0298B1DBFA4980AFEFB6625(L_44, L_47, NULL);
		NullCheck(L_48);
		MethodInfo_t* L_49;
		L_49 = VirtualFuncInvoker0< MethodInfo_t* >::Invoke(19 /* System.Reflection.MethodInfo System.Reflection.PropertyInfo::get_GetMethod() */, L_48);
		V_2 = L_49;
		MethodInfo_t* L_50 = V_2;
		bool L_51;
		L_51 = MethodInfo_op_Equality_m3F6B020142F59A9A1549CEB6C7A43798FBA18BEB(L_50, (MethodInfo_t*)NULL, NULL);
		if (!L_51)
		{
			goto IL_0127;
		}
...
IL_0127:
	{
		...
		L_54 = ReflectionUtil_CreateFuncIMessageBool_mC27C5AD4CD05891AC1EC0933611B5678CA48789B(L_53, NULL);
		...
		String_t* L_58;
		L_58 = String_Concat_mAF2CE02CC0CB7460753D0A1A91CCF2B1E9804C5D(_stringLiteral1D8BE65F4D775FA68F7EA356CD9EF08F2666FC54, L_57, NULL);
		...
		MethodInfo_t* L_60;
		L_60 = RuntimeReflectionExtensions_GetRuntimeMethod_mC91D0D6D5A70AB4B5201F67718E3C5E276454C51(L_55, L_58, L_59, NULL);
		V_3 = L_60;
		MethodInfo_t* L_61 = V_3;
		bool L_62;
		L_62 = MethodInfo_op_Equality_m3F6B020142F59A9A1549CEB6C7A43798FBA18BEB(L_61, (MethodInfo_t*)NULL, NULL);
		if (!L_62)
		{
			goto IL_0163;
		}
...
IL_0163:
	{
		...
		L_65 = ReflectionUtil_CreateActionIMessage_m6E5086C5181236168BF662877536FD4C241F8180(L_64, NULL);
...
IL_019f:
	{
		...
		RuntimeObject* L_78;
		L_78 = SingleFieldAccessor_GetDefaultValue_m124C3C618D7EC5C04D23DFBADF4BD11D70235BD0(L_77, NULL);
		NullCheck(L_74);
...
IL_005e:
	{
		...
		L_5 = ByteString_get_Empty_m731EFB022957B89D06402B50613BE2D07E64E381_inline(NULL);
		return L_5;
	}
...
IL_00a4:
	{
		...
		IL2CPP_RAISE_MANAGED_EXCEPTION(L_18, ((RuntimeMethod*)il2cpp_codegen_initialize_runtime_metadata_inline((uintptr_t*)&SingleFieldAccessor_GetDefaultValue_m124C3C618D7EC5C04D23DFBADF4BD11D70235BD0_RuntimeMethod_var)));
	}
}
